defmodule ScheduleWeb.Router do
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, html: {ScheduleWeb.Layouts, :root}
  ...
  if Application.compile_env(:schedule, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: ScheduleWeb.Telemetry
